...
volatile char curr_pattern = 0;
char curr_sub_pattern = 0;
...
void init_patterns(){
  ...
  pattern_1 = new pattern{6, new sub_pattern[6]{sub_pattern{1,0,0,0,0,0, 64000}, 
                                                sub_pattern{0,1,0,0,0,0, 64000}, 
                                                sub_pattern{0,0,1,0,0,0, 64000}, 
                                                sub_pattern{0,0,0,1,0,0, 64000}, 
                                                sub_pattern{0,0,0,0,1,0, 64000},
                                                sub_pattern{0,0,0,0,0,1, 64000}}};
...
void setup() {
  ...
  //pin 4, 7, 8 as input --> use to determine which pattern to set to
...
void update_curr_pattern(){
  ...
  // 001 --> pattern 1
  // ...
  curr_pattern = char ((PIND & 0b00010000 >> 2) | (PINB & 0b00000001 << 1) | (PINB & 0b00010000 >> 3 ));
}
